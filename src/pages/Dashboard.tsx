...
export default function Dashboard() {
  return (
    <main className="w-full grid grid-rows-4 text-white">
      <div className="grid grid-cols-6 gap-2 rounded-2xl  w-full bg-neutral-950/60 shadow shadow-neutral-700 overflow-hidden p-2">
        <article className="flex flex-col justify-start  shadow shadow-neutral-500 rounded-s-xl p-1">
          ...
          <div className="flex flex-col gap-2 p-2">
            ...
            <div className=" flex flex-col gap-4 justify-center items-center">
              <p className="bg-rose-600/90 text-rose-100 font-black px-4 py-1 rounded-sm shadow shadow-rose-400">
                BECERRA S23
              </p>
        ...
        <article className="flex flex-col justify-start  shadow shadow-neutral-500  p-1">
          ...
          <div className="grid grid-cols-2 gap-2 h-full justify-center ">
            <article className="bg-gradient-to-tr flex justify-center items-center from-blue-500 to-cyan-400 rounded">
              <p className="font-black text-2xl text-neutral-200">M100</p>
            </article>
            <article className="flex flex-col justify-center items-center text-blue-500 font-semibold">
              <button className="relative rounded-xl hover:bg-neutral-950 shadow shadow-blue-500 border hover:border-blue-400 py-2">
                Alertas
        ...
        <article className="col-span-2  gap-2 h-full justify-center ">
          ...
          <div className="grid grid-cols-2 gap-2 h-full justify-center ">
            <div>
              <Select label="Design centros" placeholder="Select a centros">
                <Select.Trigger />
                <Select.List items={centros}>
                  {(item) => (
